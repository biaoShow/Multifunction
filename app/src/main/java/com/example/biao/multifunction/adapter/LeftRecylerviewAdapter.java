...
public class LeftRecylerviewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        ((MyViewHolder) holder).tv_left_itemtext.setTag(position);
        ((MyViewHolder) holder).tv_left_itemtext.setOnClickListener(onClickListener);
    }

    View.OnClickListener onClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            leftRLItemListener.onClickItem((int) v.getTag());
        }
    };
